      ...
      {isHovered && (
        <MathJaxContext>
          <div className="tooltip-content formatted-tooltip">
            <p>The Simple Moving Average (SMA) is one of the most fundamental technical indicators in financial markets. It helps traders and analysts smooth out price data over a specific period, making it easier to identify trends. Unlike more complex moving averages, such as the Exponential Moving Average (EMA), the SMA applies equal weight to all data points, providing a straightforward way to analyze historical price movements.</p>
            <p><strong>Technical Details:</strong> SMA is calculated by summing the closing prices over a chosen period and dividing by the number of periods. The formula is: </p>
            <MathJax>
                {`\\( SMA = \\frac{\\sum_{i=0}^{N-1} P_i}{N} \\)`}
            </MathJax>
            <p>where P represents the price at period i, and N is the number of periods used in the calculation.</p>
            <p>Traders use SMA for various purposes, including trend identification, support and resistance levels, and trading signals. A rising SMA suggests a bullish trend, while a declining SMA indicates a bearish trend. When a short-term SMA crosses above a long-term SMA, it can signal a potential buying opportunity, while the opposite crossover may suggest a sell signal.</p>
          </div>
        </MathJaxContext>
      )}
    </div>
